                    ...
                    <div class="flex flex-wrap items-center justify-between">
                        <div class="flex items-center justify-start">
                            <form action="#" method="GET" class="lg:block lg:pl">
                                <label for="topbar-search" class="sr-only">Número de entrada - salida</label>
                                <div class="mt-1 relative lg:w-64">
                                    <input type="text" name="email" id="topbar-search"
                                        ...
                                        placeholder="Número de entrada - salida">
                                </div>
                            </form>
                        </div>
                                            ...
                                            <x-slot name="trigger">
                                                <span class="inline-flex rounded-md">
                                                    <button type="button"
                                                        ...
                                                        <span class="ml-2 hidden sm:inline-block">Descargar</span>
